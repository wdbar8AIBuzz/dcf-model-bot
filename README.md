...
This is a single React component built for Claude's Artifact environment. To run standalone:

1. Scaffold a React app (e.g. `npx create-react-app dcf-bot`)
2. Replace `src/App.js` with `dcf-model-bot.jsx`
3. Add your Anthropic API key to the fetch headers
4. `npm start`

> **Note:** The Anthropic API key is handled externally in the deployed version. Never commit API keys to source control.
...
[LinkedIn](https://www.linkedin.com/in/williamdunbar8)
